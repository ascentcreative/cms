    ...
    <div class="cms-wrap">
        <div class="col cms-sidebar" id="sidebar">
            ...
            <div class="cms-sidebar-footer">
                ...
                {{-- <div style="margin-top: 10px; color: #777; font-size: 10px; text-align: center;">Powered by <br/>Ascent CMS 3.0-beta <img src="/vendor/ascent/cms/img/ascent-badge-trans.png" style="height: 1rem" alt="Ascent" /></div> --}}
