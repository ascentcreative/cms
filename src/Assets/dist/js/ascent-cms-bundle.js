...
var ModalLink = {
  ...
  showResponseModal: function showResponseModal(data) {
    ...
    $('#ajaxModal').modal({}); // if we removed the fade class, re-add it now so this one fades out nicely!
          ...
          statusCode: {
            ...
            422: function _(data, xhr, request) {
              ...
              for (fldname in errors) {
                ...
                $(form).find('.error-display[for="' + aryname + '"]').append('<small class="validation-error alert alert-danger form-text" role="alert">' + val + '</small>');
              }
            },
...
$.extend($.ascent.StateManager, {}); // $(document).ready(function() {
